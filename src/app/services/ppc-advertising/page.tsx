...
function PPCHero() {
  ...
  return (
    <section
      ref={ref}
      className="relative isolate h-[100svh] lg:min-h-[100svh] flex items-start lg:items-center pt-20 pb-6 lg:pt-24 lg:pb-12 texture-grain overflow-hidden bg-brand-navy"
    >
      {/* Ambient gradients */}
      <div
        aria-hidden
