        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:sticky lg:top-32">
            <motion.span
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, ease: EASE }}
              className="inline-flex items-center gap-2 rounded-full bg-brand-azure/15 border border-brand-azure/30 px-5 py-2 font-display text-[17px] tracking-[0.08em] text-brand-azure mb-5"
            >
              <span className="h-1.5 w-1.5 rounded-full bg-brand-yellow" />
              IS THIS FOR YOU?
            </motion.span>
