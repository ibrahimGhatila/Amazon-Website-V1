      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="max-w-3xl mb-10">
          <motion.span
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, ease: EASE }}
            className="inline-flex items-center gap-2 rounded-full bg-brand-yellow/10 border border-brand-yellow/25 px-4 py-1.5 font-display text-[15px] tracking-[0.14em] text-brand-yellow mb-4"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-brand-yellow animate-pulse" />
            WEEKLY REPORT
          </motion.span>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <motion.span
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, ease: EASE }}
            className="inline-flex items-center gap-2 rounded-full bg-brand-yellow/10 border border-brand-yellow/25 px-4 py-1.5 font-display text-[15px] tracking-[0.14em] text-brand-yellow mb-5"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-brand-yellow animate-pulse" />
            GET STARTED
          </motion.span>
