...
import { ArrowRight, Users, Trophy, Globe2 } from "lucide-react";
...
export function AboutHero() {
  ...
  return (
    ...
    >
      {/* Ambient gradients — same as Hero */}
      <div
        aria-hidden
        ...
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              team behind 1,200+ launches, a 1M+ community, and the largest
          ...
          {/* Right — Visual composition (same pattern as Hero) */}
          <motion.div
          ...
          >
            ...
            >
              ...
              <div className="mt-3 flex items-baseline gap-1">
                ...
                <Users className="h-5 w-5 text-brand-yellow ml-2" />
              </div>
              <div className="mt-3 text-white/60 text-sm leading-relaxed">
                Sellers, mentees, and operators across our ecosystem.
              </div>
