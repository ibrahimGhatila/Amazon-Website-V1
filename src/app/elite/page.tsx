          ...
          >
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full bg-brand-yellow/15 border border-brand-yellow/30 px-4 py-1.5 mb-5">
                ...
                <span className="font-display text-[17px] tracking-[0.08em] text-brand-yellow">BUILT FOR YOU IF...</span>
              </div>
          ...
          >
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 rounded-full bg-brand-navy/5 border border-brand-navy/10 px-4 py-1.5 mb-5">
                ...
                <span className="font-display text-[17px] tracking-[0.08em] text-brand-navy/60">NOT THE RIGHT FIT IF...</span>
              </div>
              <ul className="space-y-3">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="text-center mb-10">
          <motion.span
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, ease: EASE }}
            className="inline-flex items-center gap-2 rounded-full bg-brand-azure/15 border border-brand-azure/30 px-5 py-2 font-display text-[17px] tracking-[0.08em] text-brand-azure"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-brand-yellow" />
            THE MODEL, EXPLAINED
          </motion.span>
        ...
        >
          ...
          <div className="flex lg:flex-col items-center justify-center gap-3">
            ...
            <span className="font-display text-[17px] tracking-[0.08em] text-white/30">SPLIT</span>
            <div className="h-[1px] w-12 lg:h-12 lg:w-[1px] bg-white/15" />
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={`${isEven ? "sm:text-right sm:pr-12" : "sm:pl-12"}`}>
                    <span className="font-display text-[17px] tracking-[0.08em] text-brand-azure">
                      {m.range}
                    </span>
              ...
              >
                ...
                >
                  <div className="flex items-start gap-4 sm:gap-5 flex-1">
                    <span className="font-display text-[17px] tracking-[0.08em] text-brand-yellow pt-1 tabular-nums">
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 text-center">
        <motion.span
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6, ease: EASE }}
          className="inline-flex items-center gap-2 rounded-full bg-brand-yellow/10 border border-brand-yellow/25 px-5 py-2 font-display text-[17px] tracking-[0.08em] text-brand-yellow mb-6"
        >
