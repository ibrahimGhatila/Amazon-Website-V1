...
function ApplyHero() {
  ...
  return (
    <section
      ref={ref}
      className="relative isolate min-h-[85vh] flex items-center pt-24 pb-12 texture-grain overflow-hidden bg-brand-navy text-white"
    >
      ...
      <motion.div style={{ opacity: contentOpacity }} className="relative mx-auto max-w-7xl px-4 sm:px-6 w-full">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.4, duration: 0.8 }}
          className="hidden lg:flex absolute bottom-6 left-1/2 -translate-x-1/2 flex-col items-center gap-2 text-white/35 text-xs font-display tracking-[0.2em] z-10">
          <span>APPLY</span>
