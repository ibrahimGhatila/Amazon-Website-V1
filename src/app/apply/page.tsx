        ...
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <div>
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
              ...
              <span className="font-display text-[17px] sm:text-[20px] tracking-[0.06em] text-brand-yellow">NOW ACCEPTING APPLICATIONS</span>
            </motion.div>
            ...
            return (
              <motion.div key={s.n} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-display text-[17px] sm:text-[20px] tracking-[0.06em] text-brand-yellow">{s.n}</span>
                </div>
