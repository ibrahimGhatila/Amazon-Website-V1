              ...
              >
                ...
                >
                  <div className="relative flex items-start justify-between">
                    <span className="inline-flex items-center rounded-full bg-brand-navy/5 text-brand-navy border border-brand-navy/10 px-3 py-1 font-display text-[16px] tracking-[0.08em]">
                      {item.tag}
                    </span>
